docker run --gpus '"device=0"' --rm -u 1001 -v /home:/home -ti kglee/tf:2.5.0 python /home/Alexandrite/leekanggeun/CVPR/ISCL/scripts/demo_EM.py --iter=400 --epoch=20 --batch_size=64 --lr=1e-4 --kfold=4 \
